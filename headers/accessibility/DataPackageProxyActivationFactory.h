...
public:
    ...
    // Symbol: ?CreateFactory@__DataPackageProxyActivationFactory@SuggestionUIUndocked@Experiences@ComposableShell@WindowsInternal@@SAJPEAIPEAU__abi___classObjectEntry@@AEAVGuid@Platform@@PEAPEAU__abi_IUnknown@@@Z
    static long CreateFactory(unsigned int *, __abi___classObjectEntry *, ::Platform::Guid &, __abi_IUnknown * *);
    // Category: Accessor | Source: PDB Internal
    // Symbol: ?GetTargetClassName@__DataPackageProxyActivationFactory@SuggestionUIUndocked@Experiences@ComposableShell@WindowsInternal@@SAPEB_WXZ
